...
public class Entity {
    ...
    public BufferedImage up1, up2, down1, down2, left1, left2, right1, right2,
            up3, up4, down3, down4, left3, left4, right3, right4;
    ...
    public void dropItem(Entity droppedItem){
        for (int i = 0; i < gp.obj[1].length; i++) {
            if (gp.obj[gp.currentMap][i] == null){
                ...
                gp.obj[gp.currentMap][i].worldX = worldX + solidArea.x; // the dead monster worldX
                gp.obj[gp.currentMap][i].worldY = worldY + solidArea.y; // toa do cua monster chet
                break;
            }
        }
    }
...
//                System.out.println(gp.player.getCenteredX() + " " + getCenteredX());
//                System.out.println(xDistance+ " " + straight);
//                System.out.println(yDistance + " " + horizontal);
...
//               System.out.println("Right");
        ...
        if (targetInRange){
//            System.out.println("In range of attack");
    ...
    public void attacking() {
        //motionDuration/2
        //motionDuration/2 --> motionDuration
        //motionDuration --> motionDuration2/2
        //motionDuration2/2 --> motionDuration
        spriteCounter++;
        if (spriteCounter <= motionDuration/2){ // showing attacking pic 1 during the first 5 frames
            spriteNumber = 1;
        }

        if (spriteCounter > motionDuration/2 && spriteCounter <= motionDuration){ // showing pic 2 during the next  6-25 frames
            spriteNumber = 2; //chưa dính sát thương
...
//            solidArea.height = solidAreaHeight;
        ...
        if (spriteCounter > motionDuration && spriteCounter <= motion2Duration*3/4){ // showing pic 2 during the next  6-25 frames
            spriteNumber = 3;
            ...
            // Adjust player's world x/y for the attack area
            // Based on players direction we offset player world y or x by his attack area
            System.out.println("Attack1.1: " + worldX + " - " + worldY);
            System.out.println("Attack1.2: " + solidArea.x  + " - " + solidArea.y);
            ...
            System.out.println("Attack2: " + worldX + " - " + worldY);
            // attackArea becomes solidArea
            solidArea.width = attackArea.width;
            solidArea.height = attackArea.height;
        ...
        if (spriteCounter > motion2Duration*3/4 && spriteCounter <= motion2Duration){ // showing pic 2 during the next  6-25 frames
            spriteNumber = 4;
...
//            solidArea.height = solidAreaHeight;
        ...
        if (!gp.player.invincible){ // we can give damage
            ...
            if (gp.player.guarding && gp.player.direction.equals(canGuardDirection)){
                ...
                if (gp.player.guardCounter < 20){
                    ...
                    spriteCounter -= 65; // attacking sprite returns to motion one, the monster will look like he's frozen
    ...
    public void draw(Graphics2D g2) {
        ...
        if (inCamera()){
            ...
            switch (direction) {
                case "left" -> g2.drawRect(tempScreenX+attackArea.x - attackArea.width,solidArea.y,attackArea.width,solidArea.height );
                case "right" -> g2.drawRect(tempScreenX+attackArea.x  ,solidArea.y,attackArea.width,solidArea.height );
            }
            changeAlpha(g2, 1F);
        }
    }
