...
public class CutsceneManager {
    ...
    public void scene_Lyuborge(){
        ...
        if (scenePhase == 1){
            ...
            gp.player.worldY += 2;
            gp.player.worldX += 1;
            System.out.println(gp.player.worldY + " " + gp.tileSize * 40);
            if (gp.player.worldY > gp.tileSize * 40 && gp.player.worldX > gp.tileSize * 12){
                scenePhase++;
            }
        }
        ...
        if (scenePhase == 2){
            ...
            for (int i = 0; i <gp.monster[1].length ; i++) {
                ...
                if (gp.monster[gp.currentMap][i] != null
                        && gp.monster[gp.currentMap][i].name.equals(MON_Boss.monName)){
    ...
    public void scene_Golem(){
        ...
        if (scenePhase == 1){
            ...
            gp.player.worldX += 4;
            gp.player.worldY += 1;
            if (gp.player.worldX > gp.tileSize * 25 && gp.player.worldY > gp.tileSize * 7){
                scenePhase++;
            }
        }
        ...
        if (scenePhase == 2){
            ...
            for (int i = 0; i <gp.monster[1].length ; i++) {
                ...
                if (gp.monster[gp.currentMap][i] != null
                        && gp.monster[gp.currentMap][i].name.equals(MON_Golem.monName)){
