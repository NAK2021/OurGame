...
//            System.out.println("Meet");
    ...
    public void boss_Golem(){
        if (!gp.bossBattleOn){
            gp.gameState = gp.cutsceneState;
            gp.csManager.sceneNum = gp.csManager.golem;
//            System.out.println("Meet");
        }
    }
    // MAPS
    public  void fifthMap() throws IOException{
       if ((hit(5, 40, 39, "any"))) {
            teleport(5, 7, 2);
        }
       else if ((hit(5, 40, 38, "any"))) {
            teleport(5, 7, 2);
        }
       else if ((hit(5, 14, 4, "any"))) {
           teleport(0, 34, 2);
       }
    }
