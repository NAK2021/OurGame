...
public class AssetSetter {
    ...
    public void setObject(){
        ...
        int i = 0;
        //MAP 5
        objSetter(new OBJ_Door(gp), mapNum, i, 30, 38);i++;//map moi

        // MAP 0
        mapNum = 0;
        i  = 0;
        objSetter(new OBJ_Chest(gp), mapNum, i, 3, 1);
        gp.obj[mapNum][i].setLoot(new OBJ_Sword_Steel(gp));
        i++;

        objSetter(new OBJ_Chest(gp), mapNum, i, 2, 1);
...
//
    ...
    public void setMonster(){
        ...
        int i = 0;
        //MAP 5
        monsterSetter(new MON_Boss(gp), mapNum, i, 10, 35);i++;
        monsterSetter(new MON_Golem(gp), mapNum, i, 22, 3);i++;
