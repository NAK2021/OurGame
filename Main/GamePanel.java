...
public class GamePanel extends JPanel implements Runnable {
    ...
    public final int maxScreenCol = 20;// 31;
    public final int maxScreenRow = 12;//16;
    ...
    public InteractiveTile[][] iTile = new InteractiveTile[maxMap][50];//in one map, it has 50 destructible objects as maximum
