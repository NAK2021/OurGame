...
public class TileManager {
    ...
    public TileManager(GamePanel gp) throws IOException {
        ...
        InputStream is = getClass().getResourceAsStream("/Resources/Maps/tiledata.txt");//condition
        assert is != null;
        BufferedReader br = new BufferedReader(new InputStreamReader(is));//doc condition
...
//        is = getClass().getResourceAsStream("/Resources/Maps/dungeonMapNew.txt");
        is = getClass().getResourceAsStream("/Resources/Maps/Maptest.txt");//is chua ma tran
        assert is != null;//check doc file
        br = new BufferedReader(new InputStreamReader(is));//doc du lieu tu ma tran
        ...
        mapTileNumber = new int[gp.maxMap][gp.maxWorldCol][gp.maxWorldRow]; //tao arr 3 chieu
        br.close();
//        loadMap("/Resources/Maps/Maptest.txt",0);
        ...
        loadMap("/Resources/Maps/Maptest.txt",5);
    ...
    public void loadMap(String filePath, int map){ //tao map
        try{
            ...
            while (col < gp.maxWorldCol && row < gp.maxWorldRow){
                ...
                while (col < gp.maxWorldCol){
                    ...
                    mapTileNumber[map][col][row] = num; //add du lieu vao mapTileNumber
                    col++;
                }
